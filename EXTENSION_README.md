...
Unlike the stdio config in `claude_desktop_config.json`, extensions are **portable** and work **across all devices**.
...
- ✅ `install-extension.ps1` - Automated installer
...
2. **Run `.\install-extension.ps1`** (1 min)
