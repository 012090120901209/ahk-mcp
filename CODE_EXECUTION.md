...
salesforce.updateRecord
    ...
    Parameters:
     ...
     Returns: Updated record object with confirmationCopy
...
TOOL CALL: salesforce.updateRecord(
		...
		(model needs to write entire transcript into context again)Copy
...
console.log('Deployment notification received');Copy
...
const saved = await fs.readFile('./workspace/leads.csv', 'utf-8');Copy
...
const csvPath = await saveSheetAsCsv('abc123');Copy
